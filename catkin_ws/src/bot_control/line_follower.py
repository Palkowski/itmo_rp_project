...
class SimpleMover():
    ...
    def __init__(self):
        ...
        rospy.Subscriber("cam_2/camera/image", Image, self.ring_camera_callback)
    ...
    def camera_callback(self, msg):
        ...
        mid_points = np.where(mask[int(msg.height/2)] >= 10)
    ...
    def spin(self):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                # Here!
                #u_z = 0
                self.desiredAltitude = 2
                altitude_prev = self.drone_state[2]
                self.u_z = self.K * (self.z_des - altitude_prev) - self.B*self.u_z

                # TODO: Steering control
                # Here!
                Kw = -0.01
                Bw = 0.0
                u_omega_z = Kw * self.omega_error - Bw * (self.omega_error - omega_error_prev)/dt
                ...
                Ky = 0.01
                By = 0.0
                u_y = Ky * self.y_error - By * (self.y_error - y_error_prev)/dt
